	...
	<table border="1">
		<form action='{$HTTP_ROOT}{$action}.php' method='post'>
			...
			<tr>
				...
				<td>
					<input type="datetime-local" name="start_date" value="{$date_today->format('Y-m-d')}"><input type="time" name="start_time" value="{$date_today->format('H:i')}">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="datetime-local" name="end_date" value="{$date_tomorrow->format('Y-m-d')}"><input type="time" name="end_time" value="{$date_today->format('H:i')}">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea name="long_desc" cols=100 rows=5></textarea>
				</td>
			</tr>
